...
import { Calendar, Clock, AlertCircle, Bell, DollarSign, Eye } from 'lucide-react';
          ...
          <div className="mt-auto space-y-2">
            ...
            <div className="grid grid-cols-2 gap-2">
              ...
              <Button
                size="sm"
                variant="outline"
                className={`text-xs ${isLender && !loan.is_fully_repaid ? '' : 'col-span-2'}`}
